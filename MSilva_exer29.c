...
void main()
{
    ...
    //do while para gerar a iteração e a interface com o user até que desejar terminar o programa
    do{
    ...
    if (option == 1){
        ...
        for(i=1;i<=repeatread;i++){
            ...
            printf("Insira %dº numero a adicionar: \n", i);
        ...
        for(i=1;i<=repeatread;i++){
            ...
            printf("Insira o %dº a multiplicar: \n", i);
    ...
    //Caso user inserir um valor que nao consta nas opcoes do programa este gera uma mensagem de valor nao atribuido e pede para inserir um dos valores dado por ele.
        ...
        printf("\nVALOR NÃO ATRIBUIDO. INSIRA VALORES DA TABELA \n\n");
